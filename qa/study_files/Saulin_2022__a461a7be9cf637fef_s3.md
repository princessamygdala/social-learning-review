...
- **study_id:** `a461a7be9cf637fef_s3`
- **on_website:** NO — DROPPED (verify below)
- **why_not_on_website:** Borderline -- DDM of multi-motive prosocial decision process, not learning over time. **Also published as standalone paper (doi: 10.1016/j.neuroimage.2021.118827) -- flag as duplicate_suspected if that paper appears separately in corpus.**
...
- **eligibility_flag:** Borderline -- DDM of multi-motive prosocial decision process, not learning over time. **Also published as standalone paper (doi: 10.1016/j.neuroimage.2021.118827) -- flag as duplicate_suspected if that paper appears separately in corpus.**
