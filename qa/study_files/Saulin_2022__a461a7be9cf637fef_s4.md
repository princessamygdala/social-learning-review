...
- **study_id:** `a461a7be9cf637fef_s4`
- **on_website:** NO — DROPPED (verify below)
- **why_not_on_website:** Borderline -- DDM of empathy + financial incentive decision process, not learning over time. **Also published as standalone paper (doi: 10.1080/17470919.2022.2115550) -- flag as duplicate_suspected if that paper appears separately in corpus.**
...
- **eligibility_flag:** Borderline -- DDM of empathy + financial incentive decision process, not learning over time. **Also published as standalone paper (doi: 10.1080/17470919.2022.2115550) -- flag as duplicate_suspected if that paper appears separately in corpus.**
...
- **preregistered:** Not reported  ---  ## STUDY 2: Empathy incites a sustainable prosocial decision bias (Saulin & Hein)  This study uses DDM (drift-diffusion modeling) to characterize the prosocial decision process after empathy induction at different strengths. The DDM captures decision components (z-parameter = initial bias, v-parameter = evidence accumulation, a-parameter = decision threshold) rather than modeling learning over time.
- **wc_rule1:** Yes
- **wc_rule2:** Yes
- **wc_rule3:** No
- **wc_rule4:** Yes
