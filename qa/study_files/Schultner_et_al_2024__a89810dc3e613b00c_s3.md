...
## Computational level
- **study_focus:** Observational learning of group bias from high-prejudice demonstrators
- **study_focus_short:** Observational learning of group bias from high-prejudice demonstrators
...
- **task_description:** Same paradigm as Studies 1-2, but observers viewed interactions of above-median biased demonstrators (mean group preference: 63.4%).
...
- **main_result:** - Stronger group bias in observers (β = 1.45, Wald z = 4.69; 61% group preference vs 53% in Studies 1-2) - Reward effect (β = 1.45, Wald z = 6.13) - Demonstrator-observer bias correlation: r = .39 - Misperceived group sharing difference (β = 6.60, Wald z = 6.40)
- **effect_size:** - Group effect: β = 1.45, SE = 0.31 - Reward effect: β = 1.45, SE = 0.24 - Study 3 vs Study 1 group bias: t = 3.84, df = 249 - Group misperception: β = 6.60, SE = 1.00 - Demonstrator-observer correlation: r = .39
- **learning_from:** Other (demonstrator's biased choice actions) + world (reward outcomes from group member targets)
- **learning_about:** Same as Study 1  ### ALGORITHMIC LEVEL  Same model space. Model 6 mean AIC = 99.17 (lowest). Model 5 = 107.27.
...
- **model_mb_mf:** MF
- **model_params:** α+ mean = .26, α- mean = .33, κ mean = .22, β mean = .54  All other algorithmic fields same as Study 1.  ### IMPLEMENTATION LEVEL  N/A (no neuroimaging). **analysis_type**: N/A  ### QUALITY
...
## Quality
- **sample_size:** N = 141 (from 158; 72 women, 62 men, 7 unreported; M_age = 41.72, SD = 12.42; MTurk)
