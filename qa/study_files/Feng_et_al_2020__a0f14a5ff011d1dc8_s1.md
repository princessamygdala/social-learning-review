...
## Computational level
- **study_focus:** Self-regarding reinforcement learning dysfunctions in depression, addiction, and anxiety disorders (systematic review)
- **study_focus_short:** Self-regarding reinforcement learning dysfunctions in depression, addiction
...
- **eligibility_flag:** type: review; does not use original computational modeling with human behavioral data; systematic review of 54 RL studies in depression, addiction, and anxiety. FLAG but do not exclude.
...
- **other_notes:** This is a qualitative systematic review of 54 studies using RL models to examine depression, addiction, and anxiety. No original computational modeling or behavioral data. No extraction of algorithmic or implementation level fields is appropriate.
